...
public final class ActivityUpdateUserBinding implements ViewBinding {
  ...
  private ActivityUpdateUserBinding(@NonNull LinearLayout rootView, @NonNull EditText emailEditText,
      @NonNull EditText passwordEditText, @NonNull ImageView profileImageView,
      @NonNull Button saveButton, @NonNull Button selectImageButton,
  ...
  public static ActivityUpdateUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpdateUserBinding((LinearLayout) rootView, emailEditText, passwordEditText,
          profileImageView, saveButton, selectImageButton, usernameEditText);
    }
