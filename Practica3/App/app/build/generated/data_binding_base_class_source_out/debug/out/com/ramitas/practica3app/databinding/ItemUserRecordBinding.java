...
public final class ItemUserRecordBinding implements ViewBinding {
  ...
  private ItemUserRecordBinding(@NonNull LinearLayout rootView, @NonNull TextView userEmailTextView,
  ...
  @NonNull
  public static ItemUserRecordBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemUserRecordBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_user_record, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemUserRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserRecordBinding((LinearLayout) rootView, userEmailTextView, userIdTextView,
