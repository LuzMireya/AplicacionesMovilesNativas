...
public final class ActivityDeleteUserBinding implements ViewBinding {
  ...
  private ActivityDeleteUserBinding(@NonNull LinearLayout rootView, @NonNull Button backButton,
      @NonNull LinearLayout usersLayout) {
  ...
  public static ActivityDeleteUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.usersLayout;
      LinearLayout usersLayout = ViewBindings.findChildViewById(rootView, id);
      if (usersLayout == null) {
        break missingId;
      }

      return new ActivityDeleteUserBinding((LinearLayout) rootView, backButton, usersLayout);
    }
